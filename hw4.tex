...
Conditional frequency tables over introduced nominal fetures are obtained with R-function \texttt{table} as is shown below. Results are presented in Tables \ref{tbl:cont_table_ch_timed} -- \ref{tbl:cont_table_ch_week}.
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}  
...
The same  data converted to relative frequencies by relating them to the total number of entities are presented in Tables \ref{tbl:cont_table_ch_timed_freq} -- \ref{tbl:cont_table_ch_week_freq}. 
